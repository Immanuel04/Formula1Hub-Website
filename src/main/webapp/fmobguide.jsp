	...
	<div class="row">
		<div class="col-md-12">
			<div class="card" style="background: url('./game/bg3.jpg'); /* replace with your image path */ background-size: cover; background-position: center; background-attachment: fixed;">
				<h2 class="text-center text-dark"><b><i>F1 Mobile Racing Track Guides</i></b></h2>
				<div class="card-body">
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<!-- Video on the left -->
							<video width="100%" height="auto" controls>
								<source src="tutorial\F1MobCanada2023.mp4" type="video/mp4">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-lg-6 col-md-12">
							<!-- Video on the left -->
							<video width="100%" height="auto" controls>
								<source src="tutorial\F1MobImola2023.mp4" type="video/mp4">
								Your browser does not support the video tag.
							</video>
						</div>
					</div>
				...
				<div class="card-body">
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<!-- Video on the left -->
							<video width="100%" height="auto" controls>
								<source src="tutorial\F1 MOBAustria 2023.mp4" type="video/mp4">
								Your browser does not support the video tag.
							</video>
						</div>
						<div class="col-lg-6 col-md-12 text-center">
